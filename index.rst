...
HycuおよびNutanixアドオンラボへようこそ！このワークブックには、講師によるNutanixとHycuソフトウェアの連携ソリューションのセッションが含まれています。
...
.. note::
   ...
   *<Cluster Password>* はクラスタに固有であり、ワークショップの担当者から提供されます。
...
NutanixがホストするPOC環境には、さまざまな方法でアクセスできます：
